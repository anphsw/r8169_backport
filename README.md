...
How to use:
1. Copy r8169_compat.h and r8169.c to drivers/net/ethernet/realtek directory of your kernel source
OR
2a. Get your own copy of r8169.c from linux kernel source (3.2 ... 3.18) should work fine
2b. Add: #include "r8169_compat.h" to your r8169.c
